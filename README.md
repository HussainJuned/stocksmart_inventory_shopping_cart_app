...
- **Item Management**:
  ...
  - **Multi-Category**: Items can belong to multiple categories (e.g., "Egg" in both _Prep_ and _Toppings_).
...
- They tap through tabs (_Produce, Meat, etc._).
- For each item, they adjust the **Current Quantity** to match reality.
- _Tip_: Use the search bar to jump to specific items.
...
- The list is grouped by Supplier (e.g., _Makro, Vegetable Market_).
...
_Note: If Firebase is not configured, use "Guest Mode" to run offline._
